...
<sub>Live card served by `api/ai-usage.svg.js`. It can read OpenAI organization usage/costs and GitHub Copilot AI credits when the matching server-side API keys are configured.</sub>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Obsidian-6C31E3?style=flat-square&logo=obsidian&logoColor=white" alt="Obsidian" />
